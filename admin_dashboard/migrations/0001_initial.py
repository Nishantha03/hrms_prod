    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leave_type', models.CharField(choices=[('Medical Leave', 'Medical Leave'), ('Casual Leave', 'Casual Leave'), ('Annual Leave', 'Annual Leave')], default='Casual Leave', max_length=50)),
